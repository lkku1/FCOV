...
class Attention(nn.Module):
    ...
    def __init__(self, d_model=1, r=1, p=0.1):
...
class SpyNet(nn.Module):
    ...
    def __init__(self, load_path=None, return_levels=[5]):
        ...
        self.basic_module = nn.ModuleList([BasicModule() for index in range(6)])
        if load_path:
...
class SNTemporalPatchGANDiscriminator(BaseModule):
    def __init__(
        self, nc_in, nf=32, norm='SN', use_sigmoid=True, use_bias=True, conv_type='vanilla',conv_by='3d'):
